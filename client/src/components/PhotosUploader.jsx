  ...
  const removePhoto = (ev, filename) => {
    ...
    setInputFields((prev) => {
      return {
        ...prev,
        addedPhotos: [
          ...prev.addedPhotos.filter((photo) => photo !== filename),
        ],
      };
    });
  };
  const setThumbnail = (ev, filename) => {
    ev.preventDefault();
    setInputFields((prev) => {
      return {
        ...prev,
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="absolute bottom-1 right-1 bg-black bg-opacity-50 text-white rounded-xl p-1"
                >
                  <svg
