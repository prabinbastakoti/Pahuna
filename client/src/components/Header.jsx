            ...
            <div className="relative w-2/5">
              ...
              <button className="bg-primary text-white rounded-full p-1 absolute md:top-4 md:right-4 lg:top-3 lg:right-4">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="lg:w-5 lg:h-5 md:w-3 md:h-3"
                >
                  <path
                    strokeLinecap="round"
