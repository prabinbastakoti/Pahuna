...
const ProfilePage = () => {
  ...
  function linkClasses(type) {
    let classes = 'flex gap-1 py-2 px-3 md:px-6 rounded-full items-center';
    ...
    <div>
      <nav className="w-full flex justify-center my-8 gap-2">
        ...
        >
          ...
          <span className="text-sm">Accomodations</span>
        </Link>
      </nav>
      {subpage === 'profile' && (
        <div className="text-center">
          ...
          <button
            className="bg-primary text-white px-6 py-2 rounded-full mt-4 text-sm"
            onClick={logout}
          >
            logout
          </button>
